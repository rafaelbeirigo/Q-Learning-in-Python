...
def plot():
    ...
    pi0  = pl.loadtxt(experimento + "/90/PRQL/w.out")
    pi1  = pl.loadtxt(experimento + "/91/PRQL/w.out")
    pi2  = pl.loadtxt(experimento + "/92/PRQL/w.out")
    pi3  = pl.loadtxt(experimento + "/93/PRQL/w.out")
    pi4  = pl.loadtxt(experimento + "/94/PRQL/w.out")
    pi5  = pl.loadtxt(experimento + "/95/PRQL/w.out")
    pi6  = pl.loadtxt(experimento + "/96/PRQL/w.out")
    pi7  = pl.loadtxt(experimento + "/97/PRQL/w.out")
    pi8  = pl.loadtxt(experimento + "/98/PRQL/w.out")
    pi9  = pl.loadtxt(experimento + "/99/PRQL/w.out")
    pi10 = pl.loadtxt(experimento + "/100/PRQL/w.out")

    ql = pl.loadtxt(experimento +   "/90/QL/w.out")
