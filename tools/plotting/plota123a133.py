...
def plot():
    ...
    pi0  = pl.loadtxt(experimento + "/123/PRQL/w.out")
    pi1  = pl.loadtxt(experimento + "/124/PRQL/w.out")
    pi2  = pl.loadtxt(experimento + "/125/PRQL/w.out")
    pi3  = pl.loadtxt(experimento + "/126/PRQL/w.out")
    pi4  = pl.loadtxt(experimento + "/127/PRQL/w.out")
    pi5  = pl.loadtxt(experimento + "/128/PRQL/w.out")
    pi6  = pl.loadtxt(experimento + "/129/PRQL/w.out")
    pi7  = pl.loadtxt(experimento + "/130/PRQL/w.out")
    pi8  = pl.loadtxt(experimento + "/131/PRQL/w.out")
    pi9  = pl.loadtxt(experimento + "/132/PRQL/w.out")
    pi10 = pl.loadtxt(experimento + "/133/PRQL/w.out")

    ql = pl.loadtxt(experimento +   "/123/QL/w.out")
