...
def plot():
    ...
    pi0  = pl.loadtxt(experimento + "/101/PRQL/w.out")
    pi1  = pl.loadtxt(experimento + "/102/PRQL/w.out")
    pi2  = pl.loadtxt(experimento + "/103/PRQL/w.out")
    pi3  = pl.loadtxt(experimento + "/104/PRQL/w.out")
    pi4  = pl.loadtxt(experimento + "/105/PRQL/w.out")
    pi5  = pl.loadtxt(experimento + "/106/PRQL/w.out")
    pi6  = pl.loadtxt(experimento + "/107/PRQL/w.out")
    pi7  = pl.loadtxt(experimento + "/108/PRQL/w.out")
    pi8  = pl.loadtxt(experimento + "/109/PRQL/w.out")
    pi9  = pl.loadtxt(experimento + "/110/PRQL/w.out")
    pi10 = pl.loadtxt(experimento + "/111/PRQL/w.out")

    ql = pl.loadtxt(experimento +   "/101/QL/w.out")
