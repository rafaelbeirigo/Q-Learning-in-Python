...
def plot():
    ...
    pi2 = pl.loadtxt(experimento + "/28/PRQL/w.out")
    pi3 = pl.loadtxt(experimento + "/29/PRQL/w.out")
    pi4 = pl.loadtxt(experimento + "/30/PRQL/w.out")
    pi5 = pl.loadtxt(experimento + "/31/PRQL/w.out")
