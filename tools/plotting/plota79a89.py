...
def plot():
    ...
    pi0  = pl.loadtxt(experimento + "/79/PRQL/w.out")
    pi1  = pl.loadtxt(experimento + "/80/PRQL/w.out")
    pi2  = pl.loadtxt(experimento + "/81/PRQL/w.out")
    pi3  = pl.loadtxt(experimento + "/82/PRQL/w.out")
    pi4  = pl.loadtxt(experimento + "/83/PRQL/w.out")
    pi5  = pl.loadtxt(experimento + "/84/PRQL/w.out")
    pi6  = pl.loadtxt(experimento + "/85/PRQL/w.out")
    pi7  = pl.loadtxt(experimento + "/86/PRQL/w.out")
    pi8  = pl.loadtxt(experimento + "/87/PRQL/w.out")
    pi9  = pl.loadtxt(experimento + "/88/PRQL/w.out")
    pi10 = pl.loadtxt(experimento + "/89/PRQL/w.out")

    ql = pl.loadtxt(experimento +   "/79/QL/w.out")
