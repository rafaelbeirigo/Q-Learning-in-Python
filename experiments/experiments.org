...
* Testes da versão probabilística
** 49 QL x PRQL determinístico x PRQL probabilístico
*** Políticas utilizadas 
**** PRQL determinístico: política obtida pelo QL
**** PRQL probabilístico: política obtida pelo QL com probabilidade 1.0 para cada linha
